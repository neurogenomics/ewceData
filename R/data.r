...
#' }
#' @examples mouse_to_human_homologs <- ewceData::mouse_to_human_homologs()
#'
"mouse_to_human_homologs"
...
#' }
#' @examples all_mgi <- ewceData::all_mgi()
#'
"all_mgi"
...
#' }
#' @examples all_hgnc_wtEnsembl <- ewceData::all_hgnc_wtEnsembl()
#'
"all_hgnc_wtEnsembl"
...
#' }
#' @examples all_hgnc <- ewceData::all_hgnc()
#'
"all_hgnc"
...
#' @examples example_genelist <- ewceData::example_genelist()
"example_genelist"
...
#' PMID:17845826
#' @examples tt_alzh <- ewceData::tt_alzh()
"tt_alzh"
...
#' The table was determined based on data associated with the paper with
#' PMID:17845826
#' @examples tt_alzh_BA36 <- ewceData::tt_alzh_BA36()
"tt_alzh_BA36"
...
#' The table was determined based on data associated with the paper with
#' PMID:17845826
#' @examples tt_alzh_BA44 <- ewceData::tt_alzh_BA44()
"tt_alzh_BA44"
...
#' }
#' @examples schiz_genes <- ewceData::schiz_genes()
"schiz_genes"
...
#' }
#' @examples hpsd_genes <- ewceData::hpsd_genes()
"hpsd_genes"
...
#' }
#' @examples rbfox_genes <- ewceData::rbfox_genes()
"rbfox_genes"
...
#' }
#' @examples id_genes <- ewceData::id_genes()
"id_genes"
...
#' }
#' @examples cortex_mrna <- ewceData::cortex_mrna()
"cortex_mrna"
...
#' }
#' @examples alzh_gwas_top100 <- ewceData::alzh_gwas_top100()
"alzh_gwas_top100"
...
#' mgi_synonym_data =
#'     mgi_data[!mgi_data$Marker.Synonyms..pipe.separated.=="",]
#' save(mgi_synonym_data,file="data/mgi_synonym_data.rda", compress='xz')
#' }
#' @examples mgi_synonym_data <- ewceData::mgi_synonym_data()
"mgi_synonym_data"
