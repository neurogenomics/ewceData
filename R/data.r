...
#' }
#' @examples ewceData::ensembl_transcript_lengths_GCcontent()
#'
...
#' }
#' @examples ewceData::mouse_to_human_homologs()
#'
"mouse_to_human_homologs"
...
#' }
#' @examples ewceData::all_mgi_wtEnsembl()
#'
"all_mgi_wtEnsembl"
...
#' }
#' @examples ewceData::all_hgnc_wtEnsembl()
#'
"all_hgnc_wtEnsembl"
...
#' @examples ewceData::example_genelist()
"example_genelist"
...
#' The table was determined based on data associated with the paper with
#' PMID:17845826
#' @examples ewceData::tt_alzh_BA36()
"tt_alzh_BA36"
...
#' The table was determined based on data associated with the paper with
#' PMID:17845826
#' @examples ewceData::tt_alzh_BA44()
"tt_alzh_BA44"
...
#' }
#' @examples ewceData::alzh_gwas_top100()
"alzh_gwas_top100"
...
#' }
#' @examples ewceData::mgi_synonym_data()
"mgi_synonym_data"
